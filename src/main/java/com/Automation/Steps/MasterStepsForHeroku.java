...
import com.Automation.Pages.HerokuHomePage;
import com.Automation.Pages.Heroku_SignUpPage;

import com.Automation.Reporting.ExtentUtilities;
import com.Automation.Utilities.AutomationCore;

public class MasterStepsForHeroku {
	public  static WebDriver testdriver;
	public static String currentScenario = "";
	
	public HerokuHomePage herokuhomepage=null;
	public Heroku_SignUpPage herokusignuppage=null;
	...
	public void getsignupPage() {
		herokusignuppage =new Heroku_SignUpPage(testdriver);
		
	}
	public void getherokuhomepage() {
		herokuhomepage =new HerokuHomePage(testdriver);
